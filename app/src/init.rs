...
// use crate::{
//     build_cmd_response, create_cmd_user, log_cleanup, log_init, DEFAULT_COMMAND_ADDR,
//     DEFAULT_LOG_CLEANUP_INTERVAL, DEFAULT_LOG_PATH, DEFAULT_REGISTER_PORT,
// };
...
// use glommio::Local;
//
// pub async fn service_init(config: &Config) -> std::io::Result<()> {
//     //init log
